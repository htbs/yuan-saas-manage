    ...
    const handleFinish = useCallback(
        ...
        async (loginVals: LoginFormVals) => {
            ...
            try {
                ...
                // 登录失败 :
                const text = err && typeof err === 'object' && 'message' in err ? (err as { message?: unknown }).message : 'Login failed';
        ...
        <div className={styles['login-form']}>
            <div className={styles['login-form__card']}>
                ...
                >
                        ...
                        rules={[
                            ...
                            { max: 10, message: '至多 10 个字符' },
                            {
                                validator: (_, value) => {
                                    ...
                                    if (v.length < 3) return Promise.reject(new Error('用户名至少 3 个字符'));
                    ...
                    >
                        <Input.Password placeholder="请慎入您的密码" autoComplete="current-password" />
                    </Form.Item>
