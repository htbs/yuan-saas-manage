...
export function ShopList() {
    ...
    const {finalAllColumns, fetchList, handleSetRefetch} = useShopList(baseColumns);
    const {pagination, setPagination, setQueryParams, resetAll, setView} = useShopStore();
            ...
            <YsDraggableDialog
                ...
                footer={
                    <div style={{display: 'flex', justifyContent: 'flex-end', gap: 10}}>
                        <Button>重置</Button>
                        <Button type="primary" onClick={handleOk}>提交表单</Button>
                    </div>
                }
            >
                <SchemaForm
