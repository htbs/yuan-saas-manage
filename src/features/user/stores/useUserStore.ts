...
interface UserState {
  ...
  editId: string | null;
  queryParams: SysUserFilterListParams;
  pagination: {
    current: number;
    pageSize: number;
  };
  ...
  setView: (view: UserState["view"], id?: string | null) => void;
  // 更新搜索条件
  setQueryParams: (params: SysUserFilterListParams) => void;
  // 更新分页
...
export const useUserStore = create<UserState>()(
  persist(
    ...
    {
      name: "user-management-storage", // 存储在 localStorage 中的 Key
