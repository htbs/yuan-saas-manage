...
import {getUserInfoApi, saveUserApi, updateUserApi,} from "@/src/services/user.service";
...
export function UserEditDialog(props: UserEditDialogProps) {
    ...
    const fields: FormFieldConfig<FormData>[] = [
        ...
        },
        {
            ...
            type: "custom",
            required: false,
            ifShow: () => props.mode !== CurdActionEnum.edit,
    ...
    useEffect(() => {
        ...
        // 如果是编辑 ｜ 查看 调用接口给表单赋值
        else if ([CurdActionEnum.edit, CurdActionEnum.view].includes(props.mode) && props.userId) {
